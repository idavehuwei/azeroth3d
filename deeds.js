...
const DEEDS=[
  ...
  {id:"enter_durotar", title:"西行赭岩", desc:"首次踏入赭岩谷。",
    ...
    reward:{title:"焦土旅人"}},
  {id:"enter_ashen", title:"踏入灰烬", desc:"首次踏入"+T("zone.ashen_canyon")+"。",
    cat:"explore", need:{type:"zone", id:"ashen_canyon"},
    reward:{title:"烬营行者"}},
  {id:"enter_orgrimmar", title:"石拳城门", desc:"首次踏入"+T("zone.orgrimmar")+"。",
    cat:"explore", need:{type:"zone", id:"orgrimmar"},
    reward:{title:"兽人宾客"}},
  {id:"enter_blackrock", title:"黑曜山脊", desc:"首次踏入"+T("zone.blackrock")+"。",
    cat:"explore", need:{type:"zone", id:"blackrock"},
    reward:{title:"黑石行者"}},
