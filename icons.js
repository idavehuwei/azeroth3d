...
const RECIPES={
  ...
  wrath(cx){
    P.bg(cx,"#183018","#081008");
    P.glow(cx,32,30,18,"rgba(100,220,80,.5)");
    cx.fillStyle="#80e060";
    cx.beginPath();cx.moveTo(32,10);cx.lineTo(44,38);cx.lineTo(20,38);cx.closePath();cx.fill();
    cx.fillStyle="#e8ffc0";
    cx.beginPath();cx.arc(32,28,5,0,6.283);cx.fill();
  },
  moonfire(cx){
    P.bg(cx,"#182028","#080c14");
    P.glow(cx,32,28,18,"rgba(120,180,255,.5)");
    cx.fillStyle="#d0e8ff";
    cx.beginPath();cx.arc(32,30,14,0.2,Math.PI*1.6);cx.fill();
    cx.fillStyle="#182028";
    cx.beginPath();cx.arc(38,26,10,0,6.283);cx.fill();
  },
  rejuvenation(cx){
    P.bg(cx,"#143020","#061008");
    P.glow(cx,32,30,18,"rgba(80,220,120,.5)");
    cx.fillStyle="#60e090";
    cx.beginPath();cx.ellipse(32,34,12,16,0,0,6.283);cx.fill();
    cx.fillStyle="#c0ffd0";
  ...
  entangling(cx){
    ...
    cx.strokeStyle="#70a040";cx.lineWidth=3;
    cx.beginPath();cx.moveTo(16,48);cx.quadraticCurveTo(24,20,32,12);cx.stroke();
  ...
  healing_touch(cx){
    P.bg(cx,"#142818","#061008");
    P.glow(cx,32,30,18,"rgba(100,230,140,.5)");
    cx.fillStyle="#70e090";
    cx.beginPath();cx.moveTo(32,10);cx.quadraticCurveTo(48,28,32,50);cx.quadraticCurveTo(16,28,32,10);cx.fill();
    cx.fillStyle="#e8ffe0";
    cx.beginPath();cx.arc(32,28,6,0,6.283);cx.fill();
  },
  barkskin(cx){
    P.bg(cx,"#241810","#0c0804");
    P.glow(cx,32,32,16,"rgba(120,160,80,.4)");
    cx.fillStyle="#6a5030";
    cx.beginPath();cx.ellipse(32,34,14,18,0,0,6.283);cx.fill();
    cx.strokeStyle="#90b060";cx.lineWidth=2;
    cx.beginPath();cx.moveTo(24,20);cx.quadraticCurveTo(28,34,24,48);cx.stroke();
    cx.beginPath();cx.moveTo(40,20);cx.quadraticCurveTo(36,34,40,48);cx.stroke();
    cx.fillStyle="#80c060";
    cx.beginPath();cx.arc(32,22,5,0,6.283);cx.fill();
  },
  crusader(cx){
  ...
  portrait_druid(cx){
    P.bg(cx,"#182818","#081008");
    P.glow(cx,32,28,16,"rgba(80,200,100,.4)");
    cx.fillStyle="#80b0a0";
    cx.beginPath();cx.arc(32,24,10,0,6.283);cx.fill();
    cx.fillStyle="#2a5830";cx.fillRect(18,32,28,20);
    cx.fillStyle="#c0a060";
