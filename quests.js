...
const QUESTS=[
  ...
  {id:"mulgore_crisis", title:T("quest.mulgore_crisis_title"), subtitle:"侦察"+T("zone.barrens"),
    ...
    next:"road_to_org"},
  {id:"road_to_org", title:"石拳城之路", subtitle:"前往"+T("zone.orgrimmar"),
    chapter:"main", zone:"durotar", sort:29,
    minLevel:12, prereq:["mulgore_crisis"],
    giver:"ochre_outpost", turnIn:"org_thrall",
    objectives:[{type:"enter", zone:"orgrimmar", countKey:"road_to_org"}],
    rewards:{sideKey:"road_to_org"},
    acceptLog:"接受任务【石拳城之路】：经赭岩谷北门进入"+T("zone.orgrimmar")+"，面见大酋长石拳。",
    readyAnnounce:"已至奥格瑞玛 · 面见石拳",
    completeAnnounce:"石拳城之路 · 完成",
    next:"blackrock_gate"},
  {id:"blackrock_gate", title:"黑石山门", subtitle:"前往"+T("zone.blackrock"),
    chapter:"main", zone:"orgrimmar", sort:30,
    minLevel:14, prereq:["road_to_org"],
    giver:"org_thrall", turnIn:"br_scout",
    objectives:[{type:"enter", zone:"blackrock", countKey:"blackrock_gate"}],
    rewards:{sideKey:"blackrock_gate"},
    acceptLog:"接受任务【黑石山门】：出奥格瑞玛北门，抵达"+T("zone.blackrock")+"，与斥候黑牙会合。",
    readyAnnounce:"已至黑石山 · 找黑牙",
    completeAnnounce:"黑石山门 · 完成",
    next:"ragnaros_whisper"},
  {id:"ragnaros_whisper", title:T("quest.ragnaros_whisper_title"), subtitle:T("quest.ragnaros_whisper_sub"),
    chapter:"main", zone:"molten_core", sort:31,
    minLevel:14, prereq:["blackrock_gate"],
    giver:"br_scout", turnIn:null, autoComplete:true,
...
function resolveNpcWorldPos(npcId){
  ...
  const alias={
    ...
    org_thrall:"orgThrall",br_scout:"brScout",
