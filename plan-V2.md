...
| **G1–G7** 玩法闭环 | 部分已由 plan-v1 / merged 提前做完 | 掉落/等级/背包/天赋/存档等已在仓；plan-V2 的 G 表作对照，不重复开坑 |
| 附带 | ✅ | 小地图箭头对齐面向 + 本地视野丰富化 · `16e1934` |

**当前里程碑**：M1–M4 ✅（R0–R8）· 下一阶段对照 **G 表 / plan-v1** 补玩法缺口（不重复开坑）。
...
| **M5 · 有玩法** | G1-G7 | 掉落 / 等级 / 背包 / 新怪 / 音效 / 副本 / 天赋 / 存档 | ◐ 多数已由 v1/merged 提前完成 |

实际执行顺序与上表「推荐顺序」不同：先做了 **M1 → M3 → R4**，再回头做 **M2（R5/R6）**——地面与天空已立住，下一步用骨架动画把角色/怪物救活。
...
*基线：v1.3.5 + STEP 0 / STEP 1；plan-V2 已完成 R0–R8；渲染里程碑 M4 收口*
