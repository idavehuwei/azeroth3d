...
**当前里程碑**：M1 ✅ · M3 ✅ · M4◐（R4）· **M2 进行中（R5 ✅ → 下一刀 R6）**。
...
**一句话结论**：R0–R5（质感 + 世界 + 氛围底 + 人形会动）已齐；下一刀是 **R6 生物族群工厂**——野怪/Boss 共用动画骨架。
...
### R6 · 生物族群工厂 `creatures.js` `P0` · 1-2 次迭代 · ⬜ 下一刀
...
| **M2 · 会动了** | R5 + R6 | 人形骨架 + 动画状态机、3 个生物族群、Boss rig 化 | ◐ R5 ✅ · R6 ⬜ |
...
*基线：v1.3.5 + STEP 0 / STEP 1；plan-V2 已完成 R0–R5；下一刀 R6*
