...
**当前里程碑**：M1 ✅ · M3 ✅ · M4◐（R4）· M2 ✅ · **M4/表现（R7 ✅）** · 下一刀 **R8**。
...
**一句话结论**：R0–R6（质感 + 世界 + 氛围 + 人形/族群会动）已齐；下一刀是 **R7 战斗表现层**。
...
| **M4 · 有氛围** | R4 + R7 + R8 | 天空穹顶、跟随阴影、昼夜、VFX 注册表、性能达标 | ◐ R4+R7 ✅ · R8 ⬜ |
...
*基线：v1.3.5 + STEP 0 / STEP 1；plan-V2 已完成 R0–R7；下一刀 R8*
