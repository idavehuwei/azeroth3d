  ...
  druid:{
    branches:[
      {id:"balance",name:"平衡",nodes:[
        ...
        {id:"wrath_mastery",tier:3,name:"愤怒专精",maxRank:3,icon:"wrath",req:"improved_moon",reqRank:1,desc:"伤害提高；愤怒命中刷新月火"},
      ]},
      {id:"restoration",name:"恢复",nodes:[
        ...
        {id:"natural_spirit",tier:3,name:"自然之魂",maxRank:3,icon:"healing_touch",req:"improved_rejuv",reqRank:1,desc:"治疗量与生命上限提高"},
      ]},
    ],
  },
  /* 圣骑士 */
