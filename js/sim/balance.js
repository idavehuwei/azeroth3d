...
const BALANCE={
  ...
  nameplate:{
    ...
    minScale:.42, maxScale:.82,
    farFade:.3,              /* 远处最低不透明度（距离衰减，非 raycast） */
    labelW:3.4,              /* 姓名板默认世界宽度 */
    labelWMul:.58,           /* 压缩各处传入的 labelW */
    labelWMax:4.6,           /* 精英/稀有上限，避免占半屏 */
    fontSize:34,             /* makeLabel 画布字号 */
    minFontSize:20,          /* 过长时缩小下限 */
    labelCanvasMax:1024,
    labelCanvasMin:160,
  ...
  props:{
    ...
    treeCount:420,
    treeBaseScale:5.4,
    treeLeafTint:0xa7b886,
    treeBarkTint:0xffffff,
    treeLeafSoft:.62,
    treeBarkSoft:.88,
    deadChance:.05,
    twistedChance:.04,
