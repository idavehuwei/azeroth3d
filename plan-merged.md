...
| 阶段 | STEP | 交付 | 预估投入 |
| --- | --- | --- | --- |
| 地基 | 0-1 | BALANCE 表、SeededRng 固定世界、Entity 统一、依赖声明 | 1 次迭代 |
| v1.4 成长闭环 | 2-4 | icons.js、掉落尸体拾取、经验等级、人形基座 + 背包装备 | 2-3 次迭代 |
| v1.5 世界的呼吸 | 5-7 | 族群工厂 + 新怪×3 + 稀有精英、sfx.js、昼夜 | 2-3 次迭代 |
| v2.0 火焰之地 | 8-11 | raid.js 分段、Boss 工厂 + VFX 注册表 + 熔岩巨兽、天赋、存档 | 3-4 次迭代 |
| v3.0 远景 | 12-13 | AI 队友 → 新地图 / 牧师 / 联机 | 开放式 |
